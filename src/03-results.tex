...
\bb{Should we remove the paragraph below? Or move it to the paragraph that discusses the light?
Now it is AFTER combining both results and I feel it does not fit here.}
...
pruning is 0.87 \%, in the case of HeP and DDECn and 6.86 \% by methods \bb{What is HeL?} HeL and DDECy in the favor of the later.
...
\bb{Can you add one sentence what one should see in that figure? 
e.g., We can see that the number of branches is drastically diminished,
but the overall height of the tree remains the same. Visually, the tree is less dense.}
...
capable of tree
\bb{training sounds too AI - how about "resulting"?}
